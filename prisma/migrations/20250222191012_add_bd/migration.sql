...
CREATE TABLE "user" (
    ...
    "picture" TEXT NOT NULL DEFAULT '/upload/no-user-image.png',
...
-- AddForeignKey
ALTER TABLE "review" ADD CONSTRAINT "review_products_id_fkey" FOREIGN KEY ("products_id") REFERENCES "product"("id") ON DELETE SET NULL ON UPDATE CASCADE;
